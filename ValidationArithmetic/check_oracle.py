...
p=json.loads((root/'baseline-engine-results.json').read_text())
...
(root/'independent-numeric-audit.json').write_text(json.dumps(summary,indent=2))
with (root/'all-307-protocols.csv').open('w') as f:
